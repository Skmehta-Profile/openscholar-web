...
async function lookupMissingPublication() {
  ...
  try {
    ...
    const lookupData =
      (await response.json()) as DoiLookupResponse;
...
{showAddPublicationDialog && (
  <div
    className="fixed inset-0 z-[115] flex items-center justify-center bg-slate-950/55 px-5 py-8 print:hidden"
    role="dialog"
    aria-modal="true"
    ...
    >
      <div className="flex items-start justify-between gap-5">
        <div>
          ...
          <p className="mt-2 text-sm leading-6 text-slate-500">
            Enter a DOI to retrieve bibliographic
      ...
      <div className="mt-7">
        ...
        <p className="mt-2 text-xs text-slate-400">
          You may paste either the DOI or the complete
          doi.org URL.
        </p>
      </div>
      ...
      {doiLookupPublication && (
        <div className="mt-7">
          ...
          <div className="mt-5 rounded-2xl border border-amber-200 bg-amber-50 px-5 py-4 text-xs leading-5 text-amber-900">
            This publication will initially be saved
            as pending. It can be reviewed before
            becoming part of the public curated
            profile.
          </div>
        </div>
      )}
      ...
      <div className="mt-7 grid gap-3 sm:grid-cols-2">
        ...
        <button
          type="button"
          onClick={saveMissingPublication}
          disabled={
            !doiLookupPublication ||
            addedPublicationSubmitting
          }
