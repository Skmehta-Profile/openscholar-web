...
const csp = [
  ...
  "font-src 'self' data:",
  "connect-src 'self' https://*.supabase.co https://*.supabase.io wss://*.supabase.co wss://*.supabase.io https://api.openalex.org https://api.crossref.org https://*.razorpay.com https://api.razorpay.com https://checkout.razorpay.com",
